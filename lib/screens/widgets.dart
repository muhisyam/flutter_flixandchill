...
import 'package:flutter_flixandchill/constants/api_constats.dart';
import 'package:flutter_flixandchill/model_class/credits.dart';
...
import 'package:flutter_flixandchill/screens/cast_n_crew.dart';
import 'package:flutter_flixandchill/screens/genre_movies.dart';
    ...
    return Column(
      children: <Widget>[
        Row(
          ...
          children: <Widget>[
            Padding(
              padding: const EdgeInsets.fromLTRB(16, 15, 0, 12),
              child:
